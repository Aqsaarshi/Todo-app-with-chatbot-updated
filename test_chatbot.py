...
def test_chatbot_functionality():
    ...
    try:
        ...
        if chat_response.status_code == 200:
            ...
            if tool_calls:
                ...
                print("   No tool calls were executed (this might indicate the AI didn't recognize the command)")
    ...
    print("Check the above output to see if the AI properly recognized and executed commands.")
    print("="*60)
